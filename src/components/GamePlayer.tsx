...
export function GamePlayer({ miniGameId }: GamePlayerProps) {
  ...
  return (
    <div className="w-full bg-[#0a0a0d] border border-primary/20 rounded-md p-6 shadow-2xl relative overflow-hidden group/console">
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_40%,rgba(0,0,0,0.4))] z-10" />
      <div className="absolute inset-0 pointer-events-none opacity-[0.02] bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[size:100%_4px,3px_100%] z-10" />
